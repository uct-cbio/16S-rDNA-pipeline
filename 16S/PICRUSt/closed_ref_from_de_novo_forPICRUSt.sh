...
#Below specify your own copy of usearch11, input fasta, greengenes DB, output file
/home/kviljoen/usearch11 -usearch_global $inDir/microbiome_merged_seqs.fasta -db /bb/DB/bio/qiime/greengenes/gg_13_8_otus/rep_set/97_otus.fasta  -id 0.97 -strand plus -uc $outDir/de_novo_repset_to_GG_13_8_map.txt 
